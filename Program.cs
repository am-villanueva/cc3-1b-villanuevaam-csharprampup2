namespace CSharpRampUp
{
    class Program
    {
        static void Main()
        {
            ...
            Console.Write("Enter Temperature of Fahrenheit (ÃÂÃÂ°F): ");
            double tempInFahrenheit = GetDoubleInput();
            double tempInCelsius = (tempInFahrenheit - 32) * 5 / 9;
            Console.WriteLine("Temperature when converted to Celsius (ÃÂÃÂ°C): " + tempInCelsius);
...
Ari carried a crystal vial filled with Stardust Elixir, which granted children sweet and enchanting dreams
when sprinkled over their pillows. To illuminate the darkest nights with her radiant wand, creating a soft glow that filled
children's dreams with wonder.

Phia possessed a satchel of Gossamer Feathers, which, when blown into the wind, would carry children's dreams
to the farthest corners of Toothonia. She could also communicate with animals, using her 'Whispering Quill' to write secret
messages and relay children's wishes to their furry and feathered friends.

Jho kept a Palette of Imagination, a magical paint palette that never ran out of colors and allowed her to
create endless dreamscapes. She could paint the most vivid and fantastical dreams with her 'Prism Prism',
bringing a burst of color and joy to the sleep of children.

Mader treasured a Starry Locket, which contained a piece of the nighttime sky and granted her the ability to navigate 
through dreams with ease. Mader wove intricate dream catchers with her net that could capture children's fears
and replace them with dreams of courage and hope.

Zai held a Vial of Cosmic Dust, a shimmering substance that allowed her to create magical constellations in
the night sky as a reward for brave children. She shows children glimpses of their future potential through her
'Cosmic Mirror', inspiring them to chase their dreams."
            );
        }
    }
}